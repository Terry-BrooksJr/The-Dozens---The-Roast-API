...
from tracepointdebug.probe.response.logPoint.filter_logpoints_response import (
...
def _applyLogPoint(log_point):
    try:
        ...
        log_point_manager.put_log_point(
            log_point.get("id", None),
            file_name,
            log_point.get("fileHash", None),
            log_point.get("lineNo", None),
            client,
            log_point.get("expireDuration", None),
            log_point.get("expireCount", None),
            log_point.get("disabled", False),
