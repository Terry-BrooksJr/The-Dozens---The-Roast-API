...
from tracepointdebug.probe.request.remove_trace_point_request import (
    RemoveTracePointRequest,
)
from tracepointdebug.probe.response.remove_trace_point_response import (
...
class RemoveTracePointRequestHandler(RequestHandler):
    ...
    def handle_request(request):
        ...
        try:
            ...
            trace_point_manager.remove_trace_point(
