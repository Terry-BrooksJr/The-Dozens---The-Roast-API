...
from tracepointdebug.probe.request.logPoint.update_log_point_request import (
    UpdateLogPointRequest,
)
from tracepointdebug.probe.response.logPoint.update_log_point_response import (
...
class UpdateLogPointRequestHandler(RequestHandler):
    ...
    def handle_request(request):
        ...
        try:
            ...
            log_point_manager.update_log_point(
