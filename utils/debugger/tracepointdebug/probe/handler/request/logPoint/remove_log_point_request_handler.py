...
from tracepointdebug.probe.request.logPoint.remove_log_point_request import (
    RemoveLogPointRequest,
)
from tracepointdebug.probe.response.logPoint.remove_log_point_response import (
...
class RemoveLogPointRequestHandler(RequestHandler):
    ...
    def handle_request(request):
        ...
        try:
            ...
            log_point_manager.remove_log_point(
