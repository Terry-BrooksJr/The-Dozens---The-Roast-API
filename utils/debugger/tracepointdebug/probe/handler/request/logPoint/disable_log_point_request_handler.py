...
from tracepointdebug.probe.request.logPoint.disable_log_point_request import (
    DisableLogPointRequest,
)
from tracepointdebug.probe.response.logPoint.disable_log_point_response import (
...
class DisableLogPointRequestHandler(RequestHandler):
    ...
    def handle_request(request):
        ...
        try:
            ...
            log_point_manager.disable_log_point(
                request.log_point_id, request.get_client()
            )
