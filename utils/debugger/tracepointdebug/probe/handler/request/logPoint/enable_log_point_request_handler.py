...
from tracepointdebug.probe.request.logPoint.enable_log_point_request import (
    EnableLogPointRequest,
)
from tracepointdebug.probe.response.logPoint.enable_log_point_response import (
...
class EnableLogPointRequestHandler(RequestHandler):
    ...
    def handle_request(request):
        ...
        try:
            ...
            log_point_manager.enable_log_point(
