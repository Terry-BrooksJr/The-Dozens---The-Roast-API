...
from tracepointdebug.probe.request.enable_trace_point_request import (
    EnableTracePointRequest,
)
from tracepointdebug.probe.response.enable_trace_point_response import (
...
class EnableTracePointRequestHandler(RequestHandler):
    ...
    def handle_request(request):
        ...
        try:
            ...
            trace_point_manager.enable_trace_point(
