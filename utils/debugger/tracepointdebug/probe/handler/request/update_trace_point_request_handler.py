...
from tracepointdebug.probe.request.update_trace_point_request import (
    UpdateTracePointRequest,
)
from tracepointdebug.probe.response.update_trace_point_response import (
...
class UpdateTracePointRequestHandler(RequestHandler):
    ...
    def handle_request(request):
        ...
        try:
            ...
            trace_point_manager.update_trace_point(
                request.trace_point_id,
                request.get_client(),
                request.expire_secs,
